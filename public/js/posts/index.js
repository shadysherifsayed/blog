...
var Mustache = __webpack_require__(82);

var convertImgToSvg = function convertImgToSvg($img) {
...
$(document).on('click', '.edit.category', function () {
    var $this = $(this);
    var action = $this.attr('action');
    var categoryName = $this.closest('li').find('a').text().trim();
    Swal({
        content: {
            element: "input",
            attributes: {
        ...
        var name = input.length == 0 ? categoryName : input;
        axios.put(action, {
            name: name
