        ...
        <ul class="navbar-nav ml-auto align-items-center">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <a class="dropdown-item" href="{{ auth()->guard() == 'admin' ? url('admin/profile') : url('profile') }}"> Profile </a>
                    <a class="dropdown-item" href="{{ auth()->guard() == 'admin' ? url('admin/logout') : url('logout') }}"> Logout </a>
                </div>
            </li>
